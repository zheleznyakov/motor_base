                ...
                <div class="collapse navbar-collapse" id="navbarToggler01">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="#">Моторы</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form class="form-inline">
                        <input class="form-control mr-2 my-2" type="text" placeholder="Логин" aria-label="Имя пользователя">
                        <input class="form-control mr-2" type="password" placeholder="Пароль" aria-label="Пароль">
                        <button class="btn btn-outline-success my-2" type="submit">Вход</button>
                    </form>
                </div>
            </nav>
        </div>
